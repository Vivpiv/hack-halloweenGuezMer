...
CREATE TABLE `candie` (
  ...
  `candie_name` varchar(45) NOT NULL,
  `candie_pathpicture` varchar(45) NOT NULL,
  `have_candie` varchar(45) NOT NULL,
  `candie_quantity` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2018-10-30 11:59:04
